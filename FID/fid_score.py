...
parser.add_argument('--path1', type=str, default=64) ## real images path
parser.add_argument('--path2', type=str, default=64) ## fake images path
...
def calculate_frechet_distance(mu1, sigma1, mu2, sigma2, eps=1e-6):
    ...
    mu1 = np.atleast_1d(mu1) ## mean for generated images
    mu2 = np.atleast_1d(mu2) ## sample mean for real image/ground truth/dataset
